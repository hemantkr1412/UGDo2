                    ...
                    <div className="course">
                        ...
                        <div className="content">
                            ...
                            <div className="page1Content" style={{ display: activePage === 'page1' ? 'block' : 'none' }}>
                                <br></br>
                                <Typography variant="h5"> El diplomado estará capacitado para participar en la planificación, organización, formulación de proyectos de inversión inmobiliaria.
                                    <br></br>
