                    ...
                    <div className="course">
                        ...
                        <div className="content">
                            ...
                            <div className="page1Content" style={{ display: activePage === 'page1' ? 'block' : 'none' }}>
                                <br></br>
                                <Typography variant="h5">El diplomado estará capacitado para participar en la realización de tasaciones y valuaciones de inmuebles, a partir del conocimiento de la metodología para la valoración arquitectónica, fiscal, legal, ambiental y cultural entre otras.</Typography>
                                <br></br>
